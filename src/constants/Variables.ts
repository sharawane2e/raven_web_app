export const accessTokenKey = 'hfs_access_token';
export const accesskey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MmViOGNmMzE0ZDliZjVjMzgyNjM2MzQiLCJhY3RpdmUiOnRydWUsImlzQWRtaW4iOnRydWUsImlzS2V5QWRtaW4iOnRydWUsImVtYWlsIjoiYXNoaXNoLmt1bWFyQGUyZXJlc2VhcmNoLmNvbSIsImlhdCI6MTY1OTYwNDUyMywiZXhwIjozMTY1OTYwNDUyM30.TuHch5kXwwTUefVuBrVSZDHqrqCaK_c8AjPE2LvPC1Q';
...
export const primaryBarPPt = 'f47c3c';
...
export const copyRightText = '© 2021 | HFS Research Ltd.';

export const exportPrefix = 'HFS Dashboard - ';

export const showhidefeature = {
  significant: false,
  userCacheIcon: false,
  mycacheIcon: false,
  userIcon: false,
