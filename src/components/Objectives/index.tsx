        ...
        <div className="objectives--content">
          ...
          <div className="objectives--content--text objectives--content--border">
            <p>
              ...
              Hard Rock Sportsbook recognizes the need to build its foundational
              knowledge of the betting market and a baseline reading of its
              brand health in Florida (to start) ahead of its launch. Hard Rock
              Sportsbook is focused on :
            </p>
            <ul>
              <li>
