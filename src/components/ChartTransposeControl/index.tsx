...
import { changeChartType, transposeChart, transposeChartMulti } from "../../services/ChartService";
...
const ChartTransposeControl: React.FC<ChartTransposeControlProps> = () => {
  const { chart:{chartTranspose,questionData,bannerQuestionData} } = store.getState();
  ...
  const buttonConfig: ButtonGroupConfig[] = [
   
    {
        ...
        onClick: () => ((questionData?.type == QuestionType.MULTI && bannerQuestionData?.type == QuestionType.MULTI)||(questionData?.type == QuestionType.SINGLE && bannerQuestionData?.type == QuestionType.MULTI)||(questionData?.type == QuestionType.MULTI && bannerQuestionData?.type == QuestionType.SINGLE))?transposeChartMulti():transposeChart(),
