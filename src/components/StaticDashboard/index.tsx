    ...
    <div className="info-area">
      <CustomScrollbar>
        ...
        <ul>
          ...
          <li>
            Organizations that will thrive in the pandemic economy must be in
            step with and ultimately anticipate customer requirements and
            expectations. They will need to become pre-emptive in every sense of
            the word.
          </li>
        </ul>
        <Grid container>
          ...
          <Grid item md={6} sm={6}>
            ...
            <ul>
              ...
              <li>
                Roughly equal split across major industries that HFS tracks
                incl. BFS; insurance; healthcare & life sciences; Technology,
                media & telecom; energy & utilities; retail & CPG; industrial
