              ...
              <div className="card">
                ...
                <div className="business-objective">
                  ...
                  >
                    ...
                    clients and to successfully grow our business, it is
                    important to understand the perspectives of executive level
                    financial officers at both public and private institutions
                    and corporations. Specifically, we need to:
                    <ul>
                      <li>Better understand our target audience</li>
                      <li>
                        Increase awareness of our brand among high value
                        customers
                      </li>
